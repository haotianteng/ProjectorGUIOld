...
if(handles.surface==handles.g_Solid)
    if(handles.entity==handles.g_Spot)
        spotHeight=handles.dishRadius*handles.spotSize*pi/180;% be ware that this spotHeight is not the handles.spotHeight one which is refer to the size of spot, the latter one is for position
