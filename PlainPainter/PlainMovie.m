...
for i = 1:handles.spotNumber
    ...
    XTrail = @(Time)(SpotX(i)); %X is the x coordinate of the strip, unit is in degree, from 0 to 180 degrees.
    YTrail = @(Time)(SpotY(i));%Y is the y coordinate of the strip, unit in mm, from 0 to 10 mm.
...
save('PlainMovie1.mat',plainMovie);
